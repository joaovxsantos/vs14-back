...
public class ContatoService {
    ...
    public ContatoDto create(ContatoCreateDto contato) throws Exception {
        ...
        Contato contatoEntity = contatoRepository.create(objectMapper.convertValue(contato, Contato.class));
    ...
    public ContatoDto update(Integer id, @Valid ContatoUpdateDto contatoAtualizar) throws Exception {
        ...
        Contato contato = contatoRepository.update(getContato(id), objectMapper.convertValue(contatoAtualizar, Contato.class));
    ...
    public List<ContatoDto> listId(int id) throws Exception {
        ...
        List<Contato> contatos =  contatoRepository.list().stream().filter(contato -> contato.getIdPessoa() == id).toList();
    ...
    private Contato getContato(Integer id) throws Exception {
        Contato contatoRecuperada = contatoRepository.list().stream()
